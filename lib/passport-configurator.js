...
PassportConfigurator.prototype.setupModels = function(options) {
  ...
  this.app.relation = camelize(this.userModel.modelName,true);
  this.app.foreignKey = this.app.relation + 'Id';
  ...
  if (!this.userIdentityModel.relations[this.app.relation]) {
    this.userIdentityModel.belongsTo(this.userModel, {
        as: this.app.relation,
        foreignKey: this.app.foreignKey
    });
  }
