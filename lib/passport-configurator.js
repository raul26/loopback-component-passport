...
PassportConfigurator.prototype.setupModels = function(options) {
  ...
  this.app._passport.relation = camelize(this.userModel.modelName,true);
  this.app._passport.foreignKey = this.app._passport.relation + 'Id';
  ...
  if (!this.userIdentityModel.relations[this.app._passport.relation]) {
    this.userIdentityModel.belongsTo(this.userModel, {
        as: this.app._passport.relation,
        foreignKey: this.app._passport.foreignKey
    });
  }
